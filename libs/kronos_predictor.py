...
- predict_batch()는 fallback_tickers 우선 처리 + timeout 60% 경과 시 중단
...
class KronosPredictor:
    ...
    def predict_batch(
        ...
        Returns:
            {ticker: predict() 반환값} 딕셔너리.
            에러 발생한 종목은 결과에 포함되지 않거나 None 값을 가짐.
        """
        ...
        for ticker in ordered:
            ...
            try:
                ...
                results[ticker] = None  # type: ignore[assignment]
